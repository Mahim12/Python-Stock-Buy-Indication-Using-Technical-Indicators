...
<body>
    ...
    <div class="container mt-5 mt-lg-3">
        ...
        <div class="row mt-5">
            <div class='col-lg-10 col-md-10 col-12'>
                <h5 style="color: white;">Price MidBand Crossover Trading</h5>
            </div>
        ...
        <div class="row mt-3">
            <div class='col-lg-12 col-md-12 col-12'>
                <div class="table-content table-responsive" id="bandopen">
                    <?php
                    ...
                    adxrsirange('strategies/swing trading/trend trading/swingcrossovertrading.csv', true);
                    ?>
                </div>
            </div>
        </div>
    ...
    <script>
        setInterval(function() {
            $("#bandopen").load("bandopencrossover.php #bandopen"); // this will run after every 2 seconds
        }, 2000);
    </script>
</body>
