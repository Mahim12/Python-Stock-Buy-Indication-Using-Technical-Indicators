...
<body>
    ...
    <div class="container mt-5 mt-lg-3">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-12">
                <div class="row mt-5">
                    <div class="col-lg-12 col-md-12 col-12">
                        <h6 style="color: white;">New Percent Change</h6>
                    </div>
                    <div class="col-lg-12 col-md-12 col-12 mt-3 mb-2">
            ...
            <div class="modal fade" id="crossover" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="exampleModalLongTitle">Swing BandOpen Crossover Trading Strategy</h3>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <h5>Key things to remember on Swing BandOpen Crossover Trading</h5>
                            <ol>
                                <li>
                                    <h6>The current price is greater than the mid bollinger band value.</h6>
                                </li>
                                <li>
                                    <h6>The last 5-7 price(excluding current price) were lesser than the mid bollinger band value.</h6>
                                </li>
                                <li>
                                    <h6>Check if the RSI has been increasing.</h6>
                                </li>
                                <li>
                                    <h6>The current upperband value and the lowerband value is huge. In other words, the band is wide open.</h6>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-3 col-12">
                <div class="row mt-5">
                    <div class="col-lg-12 col-md-12 col-12">
                        <h6 style="color: white;">Bollinger-Crossover Strategy</h6>
                    </div>
                    <div class="col-lg-12 col-md-12 col-12 mt-3 mb-2">
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#crossover">
                            Learn More
                        </button>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-3 col-12">
                <div class="row mt-5">
                    <div class="col-lg-12 col-md-12 col-12">
                        <h6 style="color: white;">Range Breakout Strategy</h6>
                    </div>
                    <div class="col-lg-12 col-md-12 col-12 mt-3 mb-2">
                ...
                <div class="row">
                    <div class='col-lg-12 col-md-12 col-12'>
                        <div class="table-content table-responsive" id="rangebreakout">
                            <?php
                            $servername = "localhost";
                            $username = "root";
                            $password = "";
            ...
            <div class="col-lg-3 col-md-3 col-12">
                <div class="row mt-5">
                    <div class="col-lg-12 col-md-12 col-12">
                        <h6 style="color: white;">Trend Trading Strategy</h6>
                    </div>
                    <div class="col-lg-12 col-md-12 col-12 mt-3 mb-2">
                        <a type="button" target="_blank" href="https://www.investopedia.com/articles/technical/04/030304.asp" class="btn btn-danger">
                            Learn More
    ...
    <script>
        setInterval(function() {
            $("#bollingerrangeintraday").load("intraday.php #bollingerrangeintraday"); // this will run after every 2 seconds
        }, 2000);

        setInterval(function() {
            $("#rangebreakout").load("intraday.php #rangebreakout"); // this will run after every 2 seconds
        }, 2000);


        setInterval(function() {
            $("#rangeintradaytrading").load("intraday.php #rangeintradaytrading"); // this will run after every 2 seconds
        }, 2000);

        setInterval(function() {
            $("#bbintradaymidcrossover").load("intraday.php #bbintradaymidcrossover"); // this will run after every 2 seconds
        }, 2000);

        setInterval(function() {
            $("#moneycontrol").load("intraday.php #moneycontrol"); // this will run after every 2 seconds
        }, 10000);
    </script>
