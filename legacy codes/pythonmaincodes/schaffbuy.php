...
<body>
    ...
    <div class="container mt-5 mt-lg-3">
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="exampleModalLongTitle">Schaff Buy Trading Strategy</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <h5>Key things to remember on schaff Buy Trading</h5>
                        <ol>
                            <li>
                                <h6>The schaff trend cycle is low in the grey area.</h6>
                            </li>
                            <li>
                                <h6>The current RSI is lower or equal to 35.</h6>
                            </li>
                            <li>
                                <h6>The slope of the RSI has been down.</h6>
                            </li>
                            <li>
                                <h6>The current Price is hovering around the lower bollinger band.</h6>
                            </li>
        ...
        <div class="row mt-5">
            <div class='col-lg-10 col-md-10 col-12'>
                <h5 style="color: white;">Schaff Buy Trading</h5>
            </div>
        ...
        <div class="row mt-3">
            <div class='col-lg-12 col-md-12 col-12'>
                <div class="table-content table-responsive" id="schaffbuy">
                    <?php
                    ...
                    adxrsirange('strategies/schaffBuy/schaffbuy.csv', true);
                    ?>
                </div>
            </div>
        </div>
    ...
    <script>
        setInterval(function() {
            $("#schaffbuy").load("schaffbuy.php #schaffbuy"); // this will run after every 2 seconds
        }, 2000);
    </script>
</body>
