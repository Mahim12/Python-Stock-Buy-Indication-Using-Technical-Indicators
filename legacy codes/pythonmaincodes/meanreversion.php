...
<body>
    ...
    <div class="container mt-5 mt-lg-3">
        ...
        <div class="row mt-5">
            <div class='col-lg-10 col-md-10 col-12'>
                <h5 style="color: white;">Bollinger Mid-CrossOver Strategy</h5>
            </div>
        ...
        <div class="row mt-3">
            <div class='col-lg-12 col-md-12 col-12'>
                <div class="table-content table-responsive" id="bollingermidcrossover">
                    <?php
                    function bollingermidcrossover($filename, $header = false)
                    {
                    ...
                    bollingermidcrossover('strategies/swing trading/mean reversion/bbmidcrossover.csv', true);
                    ?>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class='col-lg-10 col-md-10 col-12'>
                <h5 style="color: white;">Adx-Rsi Range Trading</h5>
            </div>
            <div class='col-lg-2 col-md-2 col-12'>
        ...
        <div class="row mt-3">
            <div class='col-lg-12 col-md-12 col-12'>
                <div class="table-content table-responsive" id="rtrade">
                    <?php
                    ...
                    adxrsirange('strategies/swing trading/mean reversion/adxrsirange.csv', true);
                    ?>
                </div>
            </div>
        </div>
    ...
    <script>
        setInterval(function() {
            $("#bollingermidcrossover").load("meanreversion.php #bollingermidcrossover"); // this will run after every 2 seconds
        }, 2000);
        setInterval(function() {
            $("#rtrade").load("meanreversion.php #rtrade"); // this will run after every 2 seconds
        }, 2000);
    </script>
</body>
