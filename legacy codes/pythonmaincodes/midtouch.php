...
<body>
    ...
    <div class="container mt-5 mt-lg-3">
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="exampleModalLongTitle">Mid Bollinger Touch Trading Strategy</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <h5>Key things to remember on Mid Bollinger Touch Trading</h5>
                        <ol>
                            <li>
                                <h6>The prices for the last 5-7 days has been decreasing but is not less than the mid bollinger band value.</h6>
                            </li>
                            <li>
                                <h6>The current price or the last two prices has touched the mid bollinger band and started to rise again.</h6>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="row mt-5">
            <div class='col-lg-10 col-md-10 col-12'>
                <h5 style="color: white;">MidBollinger Touch Trading</h5>
            </div>
        ...
        <div class="row mt-3">
            <div class='col-lg-12 col-md-12 col-12'>
                <div class="table-content table-responsive" id="midtouch">
                    <?php
                    function midtouch($filename, $header = false)
                    {
                    ...
                    midtouch('strategies/Midtouch/midtouch.csv', true);
                    ?>
                </div>
            </div>
        </div>
    ...
    <script>
        setInterval(function() {
            $("#midtouch").load("midtouch.php #midtouch"); // this will run after every 2 seconds
        }, 2000);
    </script>
</body>
