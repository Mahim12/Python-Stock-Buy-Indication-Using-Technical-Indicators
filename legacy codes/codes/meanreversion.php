...
<body>
    ...
    <div class="container mt-5 mt-lg-3">
        ...
        <div class="row mt-3">
            <div class='col-lg-12 col-md-12 col-12'>
                <div class="table-content table-responsive" id="rtrade">
                    <?php
                    function bbsqueze($filename, $header = false)
                    {
                        $handle = fopen($filename, "r");
                        echo '<table class= "table table-sm table-hover table-striped"><thead class = "thead">';
                        //display header row if true
                    ...
                    bbsqueze('strategies/swing trading/mean reversion/bbswingsueeze.csv', true);
                    ?>
                </div>
            </div>
        </div>
    ...
    <script>
        setInterval(function() {
            $("#bollingermidcrossover").load("home.php #bollingermidcrossover"); // this will run after every 2 seconds
        }, 2000);
    </script>
</body>
